                                    ...
                                    <div className='flex flex-col gap-3'>
                                        {['Too Long', 'Just Right', 'Too Short'].map((option) => (
                                            <button
                                                ...
                                                className={`w-full h-[40px] rounded-[30px] bg-[#FFFFFF0A] border text-[14px] font-medium text-white  transition-all ${lengthFeedback === option
                                                    ? 'border-white'
                                                    : ' border-[#FFFFFF33]'
                                                    }`}
                                            >
                                    ...
                                    <div className='flex justify-center gap-3 flex-wrap'>
                                        {[0, 1, 2, 3, 4, 5, 6, 7].map((day) => (
                                            <button
                                                ...
                                                className={`w-[34px] h-[34px] rounded-full transition-all text-[17px] font-bold ${daysPerWeek === day
                                                    ? 'bg-white text-black'
