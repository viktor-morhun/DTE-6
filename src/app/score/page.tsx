...
import { motion, useMotionValue, animate, AnimatePresence, cubicBezier } from "framer-motion";
...
export default function ScorePage() {
    ...
    const allCorrect = true; // For demo purposes
    ...
    useEffect(() => {
        ...
        const unsub3 = completedMV.on("change", (v) => setCompletedVal(Math.round(v)));
        const unsub4 = streakMV.on("change", (v) => setStreakVal(Math.round(v)));
        const unsub5 = correctMV.on("change", (v) => setCorrectRowVal(Math.round(v)));
    ...
    }, [daysMV, hiteMV, completedMV, streakMV, correctMV, totalMV, allCorrect, totalTarget]);
                ...
                <div className="relative z-10 h-dvh px-4 pt-[1rem] pb-[3.125rem]">
                    <section className={twMerge("flex flex-col flex-1 mt-10")}>
                        ...
                        <motion.div
                            ...
                            className='mt-auto'
                        >
                            <Button onClick={handleNext} className="h-10 mt-[26px]" variant='text'>
                                Next
                            </Button>
                        </motion.div>
                    </section>
